...
header customdata_t {
    bit<16> proto_id;
    bit<16> content_id;
    /* TODO: add fields to store information on number
    of times the packet traverses a specific pipeline */
}
...
struct metadata {
    /* TODO: make an instance of the resubmit metadata */
}
...
control MyIngress(inout headers hdr,
    ...
    action update_customdata_processing_count_by_num(in bit<8> ingress_num) {
        /* TODO: update field of CustomData header with a
        specific number, increment given by argument, etc */
    }
    ...
    action customdata_forward(egressSpec_t port) {
        /* TODO: define logic to forward packet with CustomData header */
    }

    action recirculate_packet() {
        /* TODO: add logic to execute the recirculation
        process by using the specific metadata */
    }
    ...
    apply {
        ...
        if (hdr.customdata.isValid()) {
            /* TODO: add logic to update the number of processing times in the
            pipelines, then recirculate the packet for the first time (using
            standard_metadata for it) */
...
control MyEgress(inout headers hdr,
    ...
    apply {
        /* TODO: add logic to update the number of processing times in the pipelines */
    }
}
