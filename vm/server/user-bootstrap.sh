...
# Set proper permissions to PIP local folder
...
# --- Tutorials --- #
sudo -H pip install crcmod
sudo git clone https://github.com/p4lang/tutorials /home/p4/p4lang-tutorials
sudo chown -R p4:p4 /home/p4/p4lang-tutorials
sudo git clone https://github.com/CarolinaFernandez/p4-tutorials /home/p4/tutorials
